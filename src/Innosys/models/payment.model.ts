...
const paymentSchema = new mongoose.Schema(
  {
    ...
    // ✅ jobId ya no es obligatorio (solo se usa si es pago por servicio)
    jobId: { type: mongoose.Schema.Types.ObjectId, ref: 'Job', required: false, default: null },

    // ✅ tipo de operación (para distinguir si es recarga, job, etc.)
    operationType: {
      type: String,
      enum: ['job-payment', 'recarga-wallet', 'other'],
      default: 'job-payment',
    },
